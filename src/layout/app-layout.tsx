...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'driver'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Cities', path: '/cities', entity: 'city', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    { name: 'Prices', path: '/prices', entity: 'price', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
