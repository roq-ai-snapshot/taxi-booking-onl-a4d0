...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Taxi booking online`}</title>

        <meta
          name="description"
          content="Experience Taxi Booking Online - Your gateway to quick and affordable outstation cab bookings. Serving all major cities with the fastest online taxi service."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1490650404312-a2175773bbf5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0YXhpfGVufDB8fHx8MTY5NzEwNTEwM3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@lexianderson?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Lexi Anderson`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Taxi Booking Online - Your gateway to quick and affordable outstation cab bookings. Serving all major cities with the fastest online taxi service.`}
            </Text>
            <Box
